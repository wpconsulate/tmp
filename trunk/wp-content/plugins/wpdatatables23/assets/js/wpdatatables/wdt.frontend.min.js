...
jQuery(input).val(defaultValue);oTable.api().column(columnIndex).search(defaultValue,bIsNumber,!1);if(!serverSide){jQuery(document).ready(function(){jQuery(input).trigger('keyup')});oTable.fnFilter(defaultValue,columnIndex)}}}
